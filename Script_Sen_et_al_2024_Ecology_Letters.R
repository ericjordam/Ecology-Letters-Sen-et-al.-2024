...
# !!!!! Note: the published data in the dois provided for sediment pigments had
# mistakes and all data were zero, so while making this script they were being
# updated and should be replaced with the corrected data. Meanwhile, data is provided
# as excel file in submission.
# ------------------------------------------------------------------------------#
