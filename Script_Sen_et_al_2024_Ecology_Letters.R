...
# ---------------------- Sen et al. 2024; Ecology Letters -------------------- #
################################################################################
# Script creator: Èric Jordà Molina - 05.02.2024 #
# ---------------------------------------------------------------------------- #
...
# Q1: doi: https://doi.org/10.11582/2023.00030
# Q2: doi: https://doi.org/10.11582/2023.00031
# Q3: doi: https://doi.org/10.11582/2023.00032
# Q4: doi: https://doi.org/10.11582/2023.00033
...
# Note: the published data in the dois provided for sediment pigments had mistakes and 
# all data were zero, so while making this script they were being updated and should 
# be replaced with the corrected data. Meanwhile, data is provided as excel file in 
# submission.
# ------------------------------------------------------------------------------#


################################################################################
####### - Macrofauna dataset Nansen Legacy - Jordà-Molina et al.,2024 - ########
...
#use abundance and biomass from macrofauna dataset above

#multiple regression: 
library(tidyverse) 
mult_regresssion <- read.csv("./mult_regresssion_0-1cm_forTOC_N.csv", sep = ";", header = TRUE)
